...
final class HumoVirtualCell:UICollectionViewCell {
    ...
    private  func createImageView() {
        ...
        imageView.image = UIImage(named: "HumoVirtual")
    ...
    private func createLabels() {
        ...
        NSLayoutConstraint.activate([
            ...
            label2.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -30),
            label2.widthAnchor.constraint(equalToConstant: 226.8299)
        ])
        label2.text = "Bankga tashrif buyurmasdan xarid..."
