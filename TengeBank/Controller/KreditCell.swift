...
final class KreditCell:UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        label.text = "Mavjud kredit miqdorini tekshiring"
        ...
        NSLayoutConstraint.activate([
            button.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 200),
